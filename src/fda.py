...
# TODO: remove target_size and directly perform transformation over all sizes.
...
if not args.val_beta:
    for target in targets:
        ...
        for src_q_path in src_q_paths: # FDA over train or val queries
            ...
            output_path = src_q_path + "_" + "pseudo" + "_" + target + "_" + args.target_size + "shots"
...
# Tune beta
    ...
    print(f"Time for beta validation on {val_size*len(beta_vals)*len(targets)} images: {time.time() - start}s")